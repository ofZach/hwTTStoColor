...
class xbeeSRst {
	...
	bool getDataAuto(int _timeOut=500);                   //automaticaly allocates memory for incoming data
	bool getData(byte * _receivedData, int _timeOut=500); //declares what array to use for incoming data
