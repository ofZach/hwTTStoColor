...
string JSONExporter::getJSON(string text, ofSoundBuffer & soundBuffer, vector<ofColor> & colorsForMessage, int time, unsigned char _data[36], string decodedData){
	json.clear();
	colors.clear();
